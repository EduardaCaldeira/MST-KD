...
def main(args):
    ...
    if cfg.is_teacher_baseline:
        if cfg.is_dual_layer:
            if cfg.has_drop_out:
                cfg.output_KD="/nas-ctm01/homes/mecaldeira/output/KD/EArc/baseline/dropout_dual_layer_"+str(cfg.middle_layer_size)+"/"+cfg.network+"/lr_"+str(cfg.lr_fc)+"_ep_"+str(cfg.num_epoch_fc)+"/"+cfg.arc_method
                ...
                cfg.output_KD="/nas-ctm01/homes/mecaldeira/output/KD/EArc/baseline/dual_layer_"+str(cfg.middle_layer_size)+"/"+cfg.network+"/lr_"+str(cfg.lr_fc)+"_ep_"+str(cfg.num_epoch_fc)+"/"+cfg.arc_method
            ...
            cfg.output_KD="/nas-ctm01/homes/mecaldeira/output/KD/EArc/baseline/"+cfg.network+"/lr_"+str(cfg.lr_fc)+"_ep_"+str(cfg.num_epoch_fc)+"/"+cfg.arc_method
        ...
        if cfg.is_dual_layer:
            if cfg.has_drop_out:
                cfg.output_KD="/nas-ctm01/homes/mecaldeira/output/KD/EArc/dropout_dual_layer_"+str(cfg.middle_layer_size)+"/"+cfg.network+"/lr_"+str(cfg.lr_fc)+"_ep_"+str(cfg.num_epoch_fc)+"/"+cfg.arc_method
                ...
                cfg.output_KD="/nas-ctm01/homes/mecaldeira/output/KD/EArc/dual_layer_"+str(cfg.middle_layer_size)+"/"+cfg.network+"/lr_"+str(cfg.lr_fc)+"_ep_"+str(cfg.num_epoch_fc)+"/"+cfg.arc_method            
            ...
            cfg.output_KD="/nas-ctm01/homes/mecaldeira/output/KD/EArc/"+cfg.network+"/lr_"+str(cfg.lr_fc)+"_ep_"+str(cfg.num_epoch_fc)+"/"+cfg.arc_method
