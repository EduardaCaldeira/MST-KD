...
def main(args):
    ...
    if cfg.loss == "ElasticArcFace":
        ...
        header = losses.RaceFace(in_features=cfg.embedding_size, out_features=cfg.num_classes, s=cfg.s, m=cfg.m).to(local_rank)
    else:
    ...
    logging.info("Train complete for %s samples.", cfg.ethnicity)
